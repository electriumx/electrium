                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        ...
                        {item.discount && item.discount > 0 && <span className="ml-1 text-destructive">(-{item.discount}%)</span>}
                      </div>
                      {item.accessories && item.accessories.length > 0 && <div className="text-xs text-muted-foreground">
                          {item.accessories.filter(acc => acc.selected).map(acc => acc.name).join(', ')}
                        </div>}
                    </div>
                  </div>
