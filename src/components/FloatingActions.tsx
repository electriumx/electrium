...
const FloatingActions = ({
  ...
  return <>
      ...
      {showCheckout && cartItemCount > 0 && <div className="fixed bottom-6 left-6 z-40">
          <Button onClick={() => navigate('/checkout')} aria-label={translateText("View Cart", currentLanguage)} className="bg-green-600 hover:bg-green-700 text-white">
      ...
      <div className="fixed bottom-6 right-6 z-40">
        {wishlistCount > 0 && (
          ...
          >
            <Heart className="mr-2 text-destructive" />
