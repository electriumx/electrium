...
const TopNavigation = () => {
  ...
  return <nav className="fixed w-full top-0 z-40">
      <div className="container mx-auto flex items-center py-4 px-6">
        <Link to="/" className="text-2xl font-bold text-[#4666F] flex items-center gap-2">
        ...
        <div className="ml-auto">
          {!isAuthenticated && <Link to="/login" className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors">
              Log In
            </Link>}
        </div>
      </div>
