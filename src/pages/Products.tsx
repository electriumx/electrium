...
const Products = () => {
  ...
  return <div className="container mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-6 flex justify-center">
        <button onClick={() => setShowSpinWheel(!showSpinWheel)} className="px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-3/4">
          <ProductGrid products={filteredProducts} onQuantityChange={handleQuantityChange} discounts={discounts} />
        </div>
      </div>
      
      <CartSummary cart={cart} />
      
      <button onClick={toggleChat} className="fixed top-4 right-4 z-50 flex items-center justify-center w-10 h-10 bg-primary text-white rounded-full shadow-lg hover:bg-primary/90 transition-transform hover:scale-105" aria-label="Chat with Electrium Assistant">
